...
@section('title', 'Litigation Customer Dispute')

@section('breadcrumb-link')
    <li class="breadcrumb-item"><a href="/user">Home</a></li>
    <li class="breadcrumb-item active">Litigation</li>
    <li class="breadcrumb-item active">Customer Dispute</li>
@endsection
...
@section('content')
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                <h5 class="card-title">Customer Dispute</h5>
                <!-- Horizontal Form -->
                <form>
                    <div class="row mb-3">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="row mb-3">
                                <label for="end_date" class="col-sm-6 col-form-label">Jenis Customer</label>
                                <div class="col-sm-6">
                                    <input type="text" name="end_date" class="form-control" id="end_date">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label for="assurance_goods" class="col-sm-6 col-form-label">Asuransi Barang</label>
                                <div class="col-sm-6">
                                    <input type="text" name="assurance_goods" class="form-control" id="assurance_goods">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label for="compensation" class="col-sm-6 col-form-label">Ganti Rugi</label>
                                <div class="col-sm-6">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-10">
                            <div class="row mb-3">
                                <label for="inputNumber" class="col-sm-6 col-form-label">MOM/Penawaran Kesepakatan Para
                                    Pihak</label>
                                <div class="col-sm-6">
                            ...
                            <div class="row mb-3">
                                <label for="inputNumber" class="col-sm-6 col-form-label">Draft Perjanjian dalam bentuk
                                    word</label>
                                <div class="col-sm-6">
                                    <input class="form-control" type="file" id="formFile">
                                </div>
