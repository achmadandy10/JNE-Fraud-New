...
@section('title', 'Litigation Outstanding')
                ...
                <form>
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <div class="row mb-3">
                                <label for="second_party" class="col-sm-6 col-form-label">Nama Perusahaan/Customer</label>
                                <div class="col-sm-6">
                        ...
                        <div class="col-md-6">
                            <div class="row mb-3">
                                <label for="start_date" class="col-sm-6 col-form-label">Nomor Perjanjian</label>
                                <div class="col-sm-6">
                                    <input type="text" class="form-control">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label for="end_date" class="col-sm-6 col-form-label">Total Outstanding</label>
                                <div class="col-sm-6">
                            ...
                            <div class="row mb-3">
                                <label for="end_date" class="col-sm-6 col-form-label">Dari Tanggal</label>
                                <div class="col-sm-6">
                                    <div class="input-group">
                            ...
                            <div class="row mb-3">
                                <label for="assurance_goods" class="col-sm-6 col-form-label">Sampai Tanggal</label>
                                <div class="col-sm-6">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-10">
                            <div class="row mb-3">
                                <label for="inputNumber" class="col-sm-6 col-form-label">Rekap Data</label>
                                <div class="col-sm-6">
                                    <input class="form-control" type="file" id="formFile">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label for="inputNumber" class="col-sm-6 col-form-label">Bukti Dokumen</label>
                                <div class="col-sm-6">
                                    <input class="form-control" type="file" id="formFile">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label for="inputNumber" class="col-sm-6 col-form-label">Perjanjian</label>
                                <div class="col-sm-6">
                                    <input class="form-control" type="file" id="formFile">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label for="inputNumber" class="col-sm-6 col-form-label">Bukti Penagihan</label>
                                <div class="col-sm-6">
                                    <input class="form-control" type="file" id="formFile">
                                </div>
                            </div>
